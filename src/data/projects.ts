...
export const PROJECTS: Project[] = [
  {
    // 시리즈 메인 카드 — 최신 회차(6월) 상세로 연결.
    // 회차가 바뀔 때마다 slug만 최신 회차로 교체하면 됨 (ex. ecology-wetland-autumn).
    ...
    operation:
      "월별 회차로 운영. 회당 선착순 16명, 생태지도사 인솔 가족 체험 프로그램. 매 회차마다 주제를 바꿔 가며 남대천의 자연을 깊이 만나는 시리즈.",
    outcome:
      "지역 자연을 가족이 함께 경험하며 생태적 감수성을 기르는 체류형 생태관광 콘텐츠.",
    description:
      "양양 남대천에서 진행되는 생태지도사와 함께하는 가족 생태체험 프로그램입니다. 매 월 새로운 주제로 운영되며, 6월에는 「바다를 이겨내는 식물들」을 주제로 해안 사구의 염생식물(갯메꽃·해란초·갯완두)을 직접 만나봅니다.",
  ...
  },
  {
    ...
    operation:
      "2거점(죽도·북분리) 분산형 1박 2일. 5팀 초청 큐레이션, 「현남 서프 패스」 회유 엔진, 선셋 공동 새참, 양쪽 바다 불꽃 피날레.",
    outcome:
      "지역경제 활성화 · 생활인구 전환 · 서핑로드 브랜딩 · 8개 마을 협력 기반. 방문객 2,000~3,000명 / 직접소비 5,000~8,000만 원 목표.",
    description:
      "2026년 7월 4(토)~5(일), 양양 죽도·북분리해변에서 열리는 1박 2일 분산형 페스티벌입니다. 단일 무대형 축제가 아닌 4거점을 순환하는 구조로, 헤드라이너 「서퍼's 나이트」·「랜드서핑 페스타」, 시그니처 「선셋 공동 새참」, 21시 양쪽 바다 동시 「불꽃 피날레」까지 — 양양 서프타운의 라이프스타일을 하루에 압축해 경험하는 자리입니다.",
    why: "「바들바들 현남생활」과 「찾아가는 새참모임」으로 쌓아온 마을 주민·관계인구 네트워크를 한자리에 모아, 외지 방문객이 마을과 관계 맺고 다시 돌아오는 구조를 만들기 위해 시작했습니다.",
    image: "/images/hyeonnam-festival-poster.png",
  },
  {
    slug: "badlbadl",
    name: "바들바들 현남생활",
