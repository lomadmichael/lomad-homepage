...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    operation:
      "「바들바들 현남생활」의 새로운 시즌으로, 3박 4일간 현남면에 머무르며 진행합니다. Ai를 처음 접하는 참가자를 위한 「Ai 첫걸음」 과정에서 시작해, 보고서·이메일·회의록 작성과 데이터 정리 등 실제 업무에 곧바로 적용하는 실전 과정으로 이어집니다. 교육 사이사이에는 서핑, 요가·명상, 러닝과 지역 정착민이 안내하는 로컬 멘토투어가 함께 진행됩니다. 1기는 2026년 9월 3일(목)~6일(일), 2기는 9월 10일(목)~13일(일)에 운영합니다.",
    outcome:
