...
export const PROJECTS: Project[] = [
  {
    // 시리즈 메인 카드 — 최신 회차(10월 연어) 상세로 연결.
    // 회차가 바뀔 때마다: 새 회차 항목을 이 자리에 추가하고, 지난 회차는 archived:true 처리.
    slug: "ecology-wetland-salmon",
    name: "남대천 생태체험 프로그램",
    oneLiner: "양양 남대천에서 진행되는 생태지도사와 함께하는 가족 생태체험 프로그램",
    category: "stay-tourism",
    target: "어린이 동반 가족 및 일반 성인",
    operation:
      "월별 회차로 운영. 타임당 선착순 15명 내외, 생태지도사 인솔 가족 체험 프로그램. 매 회차마다 주제를 바꿔 가며 남대천의 자연을 깊이 만나는 시리즈.",
    outcome:
      "지역 자연을 가족이 함께 경험하며 생태적 감수성을 기르는 체류형 생태관광 콘텐츠.",
    description:
      "양양 남대천에서 진행되는 생태지도사와 함께하는 가족 생태체험 프로그램입니다. 매 월 새로운 주제로 운영되며, 10월에는 「양양 남대천 연어 생태이야기」를 주제로 연어의 한살이와 회귀 과정, 남대천을 찾는 회귀어종을 배우고 연어전시관을 관람합니다.",
    ...
    ogImage: "/images/og-ecology-salmon.jpg",
  },
  {
    // 7~9월 회차 — 시리즈 카드에서는 숨김 처리, 상세 URL은 유지 (외부 공유 링크 살아있음).
    slug: "ecology-wetland-water",
    name: "남대천 물속 생물 이야기",
    oneLiner: "2026년 7~9월 회차 · 민물고기와 수서곤충을 만나는 가족 생태체험.",
    category: "stay-tourism",
    target: "어린이와 동반 가족, 양양을 찾는 방문자",
    operation:
      "7~9월 정규 운영. 회당 선착순 12명, 생태지도사 인솔 가족 체험 프로그램.",
    outcome:
      "지역 자연을 가족이 함께 경험하며 생태적 감수성을 기르는 체류형 생태관광 콘텐츠.",
    description:
      "양양 남대천에서 진행된 생태지도사와 함께하는 가족 생태체험 프로그램입니다. 「남대천 물속 생물 이야기」를 주제로 민물고기와 수서곤충을 족대로 직접 채집·관찰하고 다시 강으로 돌려보냅니다.",
    why: "양양 남대천은 강과 바다, 습지와 사구가 어우러진 살아있는 자연의 보고입니다. 가족이 직접 발 디디며 작은 생명들의 비밀을 풀어가는 장을 만들고자 시작했습니다.",
    image: "/images/ecology-wetland.jpg",
    archived: true,
  },
  ...
  },
  {
    ...
    target:
      "만 19세 이상 49세 이하, 타 지역에 거주하는 청년. 3기 20명을 모집하며 개인 또는 팀으로 신청할 수 있습니다.",
    operation:
      "「바들바들 현남생활」의 새로운 시즌으로, 3박 4일간 현남면에 머무르며 진행합니다. Ai를 처음 접하는 참가자를 위한 「Ai 첫걸음」 과정에서 시작해, 보고서·이메일·사업계획 작성과 데이터 정리 등 실제 업무에 곧바로 적용하는 실전 과정으로 이어집니다. 교육 사이사이에는 서핑, 요가·명상, 러닝과 지역 정착민이 안내하는 로컬 멘토투어가 함께 진행됩니다. 1·2기(2026년 9월)에 이어 3기는 2026년 10월 2일(금)~5일(월) 개천절 연휴에 운영합니다.",
    outcome:
      "참가자 각자가 자신의 일상과 업무를 재료로 만든 Ai 산출물을 완성해 발표하고, 돌아가서도 이어갈 활용 루틴을 손에 쥐게 됩니다. 여기서 맺어진 관계는 Ai로 지역 현안을 함께 풀어보는 10월 심화과정으로 이어집니다.",
    description:
      "Ai가 일하는 방식을 빠르게 바꾸고 있지만, 바쁜 일상 속에서 제대로 배울 시간을 내기는 쉽지 않습니다. 「Ai 내일바꿈」은 양양 현남면에 3박 4일 머무르며 실무에 바로 쓸 수 있는 Ai를 배우고, 바다에서 숨을 고르며 지역을 살아보는 체류형 프로그램입니다. 남의 예제가 아닌 참가자 본인의 일과 생활을 실습 재료로 삼아, 마지막 날에는 각자 완성한 결과물을 발표하는 것으로 일정을 마무리합니다. 숙박과 교육, 체험 프로그램, 터미널과 프로그램 장소를 오가는 차량 이동 지원까지 모두 무료로 제공되며, 참가 확정 시 납부하는 보증금 5만원은 Ai 결과물 제출 시 전액 환급됩니다. 3기 접수는 2026년 9월 28일(월) 오후 1시까지이며, 결과는 같은 날 오후 6시 선정자에 한해 개별 안내합니다. 1·2기 40명은 전원 완주해 각자 결과물을 발표했고, 전반 만족도 4.97점(5점 만점)·추천 의향 100%를 기록했습니다.",
