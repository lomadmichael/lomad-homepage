...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    operation:
      "2거점(죽도·북분리) 분산형 1박 2일. 「현남 서프 패스」 회유 엔진, 액티비티 체험, 북분리 캠핑장 선셋 비치 테이블·사운드 배스, 죽도 불꽃 피날레.",
    outcome:
      "지역경제 활성화 · 생활인구 전환 · 서핑로드 브랜딩 · 8개 마을 협력 기반. 방문객 7,000~8,000명 / 직접소비 1억5천~1억8천만 원 목표.",
    description:
      "2026년 7월 4(토)~5(일), 양양 죽도·북분리해변에서 열리는 1박 2일 분산형 페스티벌입니다. 단일 무대형 축제가 아닌 4거점을 순환하는 구조로, 액티비티 체험(서핑·SUP·랜드서핑·클라이밍)과 헤드라이너 「서퍼's 나이트」, 북분리 캠핑장 시그니처 「선셋 비치 테이블」·「사운드 배스」, 21시 죽도 「불꽃 피날레」까지 — 양양 서프타운의 라이프스타일을 하루에 압축해 경험하는 자리입니다.",
