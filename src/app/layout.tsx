...
export const metadata: Metadata = {
  ...
  description: "양양에서 관계를 만들고, 역할을 연결합니다. 체류 프로그램·프로젝트·상품화로 사람과 지역을 잇는 협동조합.",
  keywords: ["로마드", "로마드협동조합", "양양", "생활인구", "체류프로그램", "바들바들", "바들바들 현남생활", "현남생활", "현남부업스쿨", "부업스쿨", "커스텀하우스", "커스텀 하우스", "양양협동조합", "양양 로컬", "양양 체류"],
  verification: {
    other: {
