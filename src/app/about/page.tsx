...
const WHAT_CARDS = [
  {
    ...
    bodyExtra: "양양 생활인구를 위한 커뮤니티 플랫폼. 서퍼, 디지털 노마드, 이주민이 지역과 연결되는 공간을 만듭니다.",
  },
  {
    titleEn: "부업스쿨",
    subtitleKr: "AI 활용 실험형 프로그램",
    body: "지역에 머물고 싶지만 일과 소득의 기반이 부족한 사람을 위해, AI를 활용해 지속가능한 수입원을 스스로 만들어볼 수 있도록 돕습니다.",
    bodyExtra: "지역 기반 부업 교육 프로그램. 생활인구가 양양에서 지속가능한 수입원을 만들 수 있도록 돕습니다.",
  },
  {
  ...
  },
  {
    ...
    bodyExtra: "생활인구를 위한 공간 기획 및 운영. 코워킹, 코리빙, 커뮤니티 공간을 통해 정주 환경을 개선합니다.",
  },
];
