...
const DAY1 = [
  ...
  ["13:00", "서핑 · SUP (죽도) · 로컬 쿠킹클래스 — 블루베리 모찌 1회차 (북분리)"],
  ["14:00", "블루베리 모찌 2회차 (북분리)"],
  ["15:00", "서핑 · SUP · 랜드서핑 (죽도) · 물든 북피크닉 (북분리 · ~18:00 · 자유참여)"],
...
const DAY2 = [
  ["10:00", "요가와 자연 만다라 · 숲과 사담요가 (북분리)"],
  ["11:00", "영수증 이벤트 상품 수령 (~14:00 · 죽도 운영본부)"],
  ["14:00", "폐막"],
];
